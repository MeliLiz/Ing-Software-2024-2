...
def main():
    ...
    while(setsj1 != mayoria and setsj2 != mayoria):
        contadorSets += 1
        print("Set " + str(contadorSets))
        print("Sets: " + str(setsj1) + " - " + str(setsj2))
        if set(j1, j2, setsj1, setsj2) == 1:
            setsj1 += 1
        else:
            setsj2 += 1
...
def set(j1, j2, setsj1, setsj2):
    ...
    if juegosj1 > juegosj2 :
        #setsj1 += 1
        print("### Ganador del set: " + j1 + " ###")
        return 1
    else:
        #setsj2 += 1
        print("Ganador del set: " + j2 + " ###")
        return 2

def juego(j1, j2, juegosj1, juegosj2):
